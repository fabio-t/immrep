...
heatmaps("^M4", "M4")
heatmaps("^M4_.*\\+", "M4_only-plus")
heatmaps("^M5", "M5")
heatmaps("^M5_.*\\+", "M5_only-plus")
...
for (tp in c(1, 0.85)) {
  ...
  radarcharts("^M4", "M4", save = T)
  radarcharts("^M4_.*\\+", "M4_only-plus", save = T)
  radarcharts("^M5", "M5", save = T)
  radarcharts("^M5_.*\\+", "M5_only-plus", save = T)
