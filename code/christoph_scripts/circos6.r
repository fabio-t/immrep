...
circos6 <- function(file1, file2, file3, file4, file5, file6, fileAliases = NULL, saveFolder = NULL, cutoff = 1.0, sort = FALSE, countColors = c("#FFFFFFFF", "#0000FFFF"), linkColors = c("#FF000080")) {
    ...
    readData <- function(file) {
        data <- read.csv(file, header = TRUE, sep = "\t", colClasses = c("numeric", "character", "character", "character", "character", "numeric"))
    ...
    dataA <- rbind(data.frame(Count = 0, id = "START", factors = "A", relCount = 0, linkIndexA = 0, linkIndexB = 0, linkIndexC = 0, linkIndexD = 0, linkIndexE = 0, linkIndexF = 0, status = "1A", accumRelCount = 0), A)
    dataB <- rbind(data.frame(Count = 0, id = "START", factors = "B", relCount = 0, linkIndexA = 0, linkIndexB = 0, linkIndexC = 0, linkIndexD = 0, linkIndexE = 0, linkIndexF = 0, status = "1B", accumRelCount = 0), B)
    dataC <- rbind(data.frame(Count = 0, id = "START", factors = "C", relCount = 0, linkIndexA = 0, linkIndexB = 0, linkIndexC = 0, linkIndexD = 0, linkIndexE = 0, linkIndexF = 0, status = "1C", accumRelCount = 0), C)
    dataD <- rbind(data.frame(Count = 0, id = "START", factors = "D", relCount = 0, linkIndexA = 0, linkIndexB = 0, linkIndexC = 0, linkIndexD = 0, linkIndexE = 0, linkIndexF = 0, status = "1D", accumRelCount = 0), D)
    dataE <- rbind(data.frame(Count = 0, id = "START", factors = "E", relCount = 0, linkIndexA = 0, linkIndexB = 0, linkIndexC = 0, linkIndexD = 0, linkIndexE = 0, linkIndexF = 0, status = "1E", accumRelCount = 0), E)
    dataF <- rbind(data.frame(Count = 0, id = "START", factors = "F", relCount = 0, linkIndexA = 0, linkIndexB = 0, linkIndexC = 0, linkIndexD = 0, linkIndexE = 0, linkIndexF = 0, status = "1F", accumRelCount = 0), F)
